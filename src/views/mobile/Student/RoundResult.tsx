...
function StuMSCollapseCard({ stuMSInfo }: { stuMSInfo: MSType }) {
    ...
    return (
        <Collapse>
            <Collapse.Item title={stuMSInfo?.teaName}>
                <Flex wrap="wrap">
                    <Flex.Item span={12}>
                    ...
                    <Flex.Item span={12}>
                        {/* TODO:没有返回邮箱？？？ */}
                        <Description label="导师邮箱" value={''} />
                    </Flex.Item>
                    <Flex.Item span={12}>
                        <Description label="导师职称" value={stuMSInfo?.jobTitle} />
                    </Flex.Item>
                    <Flex.Item span={12}>
                        <Description label="研究方向" value={stuMSInfo?.keywords} />
                    </Flex.Item>
                    <Flex.Item span={12}>
                        <Description label="导师团队" value={stuMSInfo?.teamName} />
                    </Flex.Item>
                    <Flex.Item span={12}>
